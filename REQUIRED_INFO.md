...
| `business.ceo` | 김재연 | 푸터·약관 표시 | 사업자등록증 대표자 성명 |
| `business.address` | 수노을1로 191 | 푸터·통신판매업 신고 | 사업장 실소재지 주소 |
| `business.phone` | 010-6375-9204 | 고객센터 전화번호 표시 | 실제 운영 전화번호 |
| `business.email` | jaeyeon423@gmail.com | 고객센터 이메일 | 실제 수신 가능한 이메일 |
| `business.businessRegNo` | 미입력 | 푸터 공시 (법적 의무) | 사업자등록번호 확인 후 입력 |
