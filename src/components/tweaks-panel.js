...
export function TweaksPanel({ title = 'Tweaks', children }) {
  const [open, setOpen] = React.useState(true); // Default open in web template for visual demonstration
...
const __TwkCheck = ({ light }) => (
  <svg viewBox="0 0 14 14" aria-hidden="true" style={{ width: 13, height: 13, position: 'absolute', top: 6, left: 6, filter: 'drop-shadow(0 1px 1px rgba(0,0,0,.3))' }}>
