# BEFORE YOU CUT — 미용인 브랜딩 마켓플레이스

**BEFORE YOU CUT**은 헤어 디자이너, 바버 등 미용 전문가들을 위한 단조 수제 가위, 디자이너 앞치마, 바버 클리퍼 등 프리미엄 도구 및 브랜드를 거래하는 **모바일 퍼스트 반응형 웹 마켓플레이스**입니다.
...
실서버 오픈 혹은 신규 상품 등록 테스트를 위해 데이터베이스 내의 모든 상품, 셀러, 주문, 좋아요 데이터를 깨끗하게 삭제합니다 (기본 게스트 사용자 계정만 유지).
```bash
